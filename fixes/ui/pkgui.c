...
void pkguiWindowOnContentSizeChanged(uiWindow *w)
{
	uiWindowOnContentSizeChanged(w, pkguiDoWindowOnContentSizeChanged, NULL);
}
...
void pkguiMenuItemOnClicked(uiMenuItem *i)
{
	uiMenuItemOnClicked(i, pkguiDoMenuItemOnClicked, NULL);
}
